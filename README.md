...
- ⚡ Fun fact: ...
-->
# Привет, я justWestl3y! 👋

Я веб-разработчик, создаю сайты, ботов и приложения. В данный момент я работаю над сайтом для моей команды **AwsmCoders** и учусь новым технологиям для бэкенда.
